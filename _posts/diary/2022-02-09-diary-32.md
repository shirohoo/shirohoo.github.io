...
- [📦 숫자 야구 게임 구현 코드 저장소](https://github.com/olivahn/code-kata/tree/main/base-ball)
...
Expecting code to raise a throwable.
	at io.github.olivahn.baseball.app.domain.NumbersTests.createExceptionWhenInNull(NumbersTests.java:18)
```
